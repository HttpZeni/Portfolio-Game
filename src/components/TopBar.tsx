    ...
    return (
        <div className="w-full h-full flex flex-row-reverse">
            <div className="w-1/2 h-full flex flex-row justify-end items-end gap-14">
                ...
                <h1 onClick={() => ChangeSelected(3)} className={`${selected == 3 ? "text-gold-400 scale-125" : "text-ink-50 scale-100"} text-sm text-shadow-sm font-pixel cursor-pointer transition-all duration-300 hover:text-gold-300`}>Skills</h1>
                <h1 onClick={() => ChangeSelected(4)} className={`${selected == 4 ? "text-gold-400 scale-125" : "text-ink-50 scale-100"} text-sm text-shadow-sm font-pixel cursor-pointer transition-all duration-300 hover:text-gold-300`}>Contact</h1>
            </div>
